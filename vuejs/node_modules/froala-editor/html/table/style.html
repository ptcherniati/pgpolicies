...
<section id="editor">
    <div id='edit' style="margin-top: 30px;">
        ...
        <p>You can define your own table styles using the <a
            ...
            option. This option is an Object where the key represents the class name and its value is the style name
            that appears in the dropdown list. It is important to have unique keys otherwise they will not work
            properly.</p>
        <p>By default you can select multiple table styles at a time. If you want to toggle them and allow only one
            style to be selected at a time use the <a
                    href="http://www.froala.dev/wysiwyg-editor/docs/options#tableMultipleStyles"
