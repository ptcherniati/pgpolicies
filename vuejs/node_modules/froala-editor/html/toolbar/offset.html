...
<div id="editor">
    ...
    <div id='edit' style="margin-top: 200px;">
        <img alt="Old Clock" class="fr-fir fr-dii" src="../../img/photo1.jpg" width="200"/>

        <h1>Toolbar with Offset</h1>

        <p>The <a href="https://www.froala.com/wysiwyg-editor/v2.0/docs/options#toolbarStickyOffset"
                  target="_blank" title="toolbarStickyOffset option">toolbarStickyOffset</a> option is useful if you
            have <code>toolbarSticky: true</code> and you need the toolbar not to go all the way to the top of the page.
            E.g. you have a sticky header on the page and the editor's toolbar should remain below the header.</p>
