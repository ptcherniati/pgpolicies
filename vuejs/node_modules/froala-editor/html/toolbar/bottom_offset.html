...
<div id="editor">
    ...
    <div id='edit' style="margin-bottom: 200px; margin-top: 30px;">
        ...
        <p>The <a href="https://www.froala.com/wysiwyg-editor/v2.0/docs/options#toolbarStickyOffset"
                  target="_blank" title="toolbarStickyOffset option">toolbarStickyOffset</a> option also works when <a
                href="https://www.froala.com/wysiwyg-editor/v2.0/docs/options#toolbarBottom"
                target="_blank" title="toolbarBottom option">toolbarBottom</a> option is set to <code>true</code>. In
            this case the offset is relative to the bottom of the page.</p>
