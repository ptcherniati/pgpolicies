...
<div id="editor">
    <div id='edit' style="margin-top: 30px;">
        <h1>Full Featured BR</h1>

        <p>This is the full featured Froala WYSIWYG HTML editor using ENTER_BR.</p>
        ...
        blandit. Nunc eu mauris sit amet purus <strong>viverra</strong><em> gravida</em> ut a dui.
        <ul>
